...
const std::vector<cv::Point2f>& CameraCalibrator::getLastSamplePoints() {
    return samplesPoints.back();
}

const std::vector<std::vector<cv::Point2f>>& CameraCalibrator::getSamplesPoints() {
...
const cv::Mat& CameraCalibrator::getCameraMatrix() {
    return cameraMatrix;
}

const cv::Mat& CameraCalibrator::getDistCoeffs() {
    return distCoeffs;
}
