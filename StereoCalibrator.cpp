...
void StereoCalibrator::set(
	...
	calcChessboardCorners(boardSize, squareSize, chessboardCorners);
...
const cv::Mat& StereoCalibrator::getRotationMatrix() {
	return rotationMatrix;
}

const cv::Mat& StereoCalibrator::getTranslationVector() {
	return translationVector;
}

const cv::Mat& StereoCalibrator::getEssentialMatrix() {
	return essentialMatrix;
}

const cv::Mat& StereoCalibrator::getFundamentalMatrix() {
